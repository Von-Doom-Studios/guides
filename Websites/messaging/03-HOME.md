...
| Supporting text | Floki products for homes, hotels, and the spaces in between. |
| Button label | Explore Floki |
...
| Field | Copy |
|---|---|
| Section heading | The Collection |
| Section subheading | Premium lifestyle products for the home, the wardrobe, and everything in between. |
...
| Field | Copy |
|---|---|
| Testimonial 1 | "These hangers changed the way my wardrobe looks and feels. Nothing else comes close." |
| Customer 1 | M. Johnson, New York |
| Testimonial 2 | "We ordered in bulk for our boutique hotel and the quality exceeded every expectation. Guests notice." |
| Customer 2 | T. Adesanya, Hotel Operator |
| Testimonial 3 | "The pillow was the finishing detail my living room needed. Well-made, vivid, and exactly as described." |
| Customer 3 | S. Owusu, London |
